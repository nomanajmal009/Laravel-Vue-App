<template>
  <div class="min-w-[160px] w-[160px]  transition-all bg-indigo-700 text-white py-4 px-2">
    ...
    <router-link :to="{name: 'app.orders'}"
                 class="flex items-center p-2 rounded transition-colors hover:bg-black/30">
      <span class="mr-2 text-gray-300">
        <DevicePhoneMobileIcon class="w-5"/>
      </span>
      <span class="text-xs">
        Orders
      </span>
...
<script setup>
  import {HomeIcon, UserGroupIcon, UsersIcon, ListBulletIcon, ChartBarIcon, DevicePhoneMobileIcon} from '@heroicons/vue/24/outline'
</script>
